OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Kontrollen av databaskonfigurationen kunde inte genomföras.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Dessa kontroller omfattar endast MySQL, MariaDB och PostgreSQL.",
    "All database checks pass." : "Alla databaskontroller är godkända.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["%n databaskontroll har misslyckats. {link}","%n databaskontroller har misslyckats. {link}"],
    "Show the findings…" : "Visa resultaten…",
    "Unknown" : "Okänd",
    ...
    "The number of CPU threads is unknown, so the load cannot be shown as a percentage." : "Antalet CPU-trådar är okänt, så belastningen kan inte visas som en procentandel.",
    "Queries per second" : "Frågor per sekund",
    "Transactions per second" : "Transaktioner per sekund",
    ...
    "Note" : "Anteckning",
    "Show config snippet" : "Visa konfigurationsutdrag",
    "Documentation ↗" : "Dokumentation ↗",
    "Database" : "Databas",
    "Type:" : "Typ:",
    "Version:" : "Version:",
    "Size:" : "Storlek:",
    "Connected. Server version: {version}" : "Ansluten. Serverversion: {version}",
    "Database connection" : "Databasanslutning",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "Kontrollerna använder som standard samma anslutning som Nextcloud. Ange en separat anslutning här för att köra dem som en användare med behörigheter som Nextcloud inte behöver, till exempel för att läsa hela serverkonfigurationen. Lämna värdnamnet tomt för att använda standardanslutningen.",
    "Host" : "Värd",
    "Port" : "Port",
    "User" : "Användare",
    "Password (stored, leave empty to keep)" : "Lösenord (sparat, lämna tomt för att behålla)",
    "Password" : "Lösenord",
    ...
    "Save" : "Spara",
    "Configuration snippet" : "Konfigurationsutdrag",
    "Add the following to your {file}, then restart the database." : "Lägg till följande i {file} och starta sedan om databasen.",
    "Copied" : "Kopierat",
    "Copy to clipboard" : "Kopiera till urklipp",
    "Could not copy to clipboard. Select the text above manually instead." : "Det gick inte att kopiera till urklippet. Markera i stället texten ovan manuellt.",
    "Close" : "Stäng",
    ...
    "Resource usage not available" : "Resursanvändning är inte tillgänglig",
    "Monitoring pages" : "Övervakningssidor",
    "Shares" : "Delningar",
    "Users:" : "Användare:",
    "Groups:" : "Grupper:",
    "Links:" : "Länkar:",
    ...
    "All" : "Alla",
    "The database checks could not be run." : "Databaskontrollerna kunde inte köras.",
    "Database checks" : "Databaskontroller",
    "Database connection settings" : "Inställningar för databasanslutning",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Dessa kontroller omfattar endast MySQL, MariaDB och PostgreSQL. Den här servern använder en annan databas.",
    "Filter checks by status" : "Filtrera kontroller efter status",
    "No checks match this filter." : "Inga kontroller matchar filtret.",
    "_%n failing_::_%n failing_" : ["%n misslyckad","%n misslyckade"],
    "The server information could not be loaded." : "Det gick inte att läsa in serverinformationen.",
    "Try again" : "Försök igen",
    "These values stopped updating at {time}: the server is not responding." : "Dessa värden slutade uppdateras {time}: servern svarar inte.",
    "The live values could not be loaded: the server is not responding." : "Det gick inte att läsa in livevärdena: servern svarar inte.",
