OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Níorbh fhéidir cumraíocht na bunachair sonraí a sheiceáil.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Ní chlúdaíonn na seiceálacha seo ach MySQL, MariaDB agus PostgreSQL.",
    "All database checks pass." : "Éiríonn le gach seiceáil ar an mbunachar sonraí.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["Tá %n seiceáil bunachair sonraí ag teip. {link}","Tá %n seiceáil bunachair sonraí ag teip. {link}","Tá %n seiceáil bunachair sonraí ag teip. {link}","Tá %n seiceáil bunachair sonraí ag teip. {link}","Tá %n seiceáil bunachair sonraí ag teip. {link}"],
    "Show the findings…" : "Taispeáin na torthaí…",
    "Unknown" : "Anaithnid",
    ...
    "The number of CPU threads is unknown, so the load cannot be shown as a percentage." : "Níl líon na snáitheanna LAP ar eolas, mar sin ní féidir an t-ualach a thaispeáint mar chéatadán.",
    "Queries per second" : "Ceisteanna in aghaidh an tsoicind",
    "Transactions per second" : "Idirbhearta in aghaidh an tsoicind",
    "Current connections" : "Naisc reatha",
    "connections" : "naisc",
    ...
    "Value" : "Luach",
    "Setting" : "Socrú",
    "restart required" : "Tá athsheoladh ag teastáil",
    "Note" : "Nóta",
    "Show config snippet" : "Taispeáin blúire cumraíochta",
    "Documentation ↗" : "Doiciméadú ↗",
    "Database" : "Bunachar Sonraí",
    "Type:" : "Cineál:",
    "Version:" : "Leagan:",
    "Size:" : "Méid:",
    "Connected. Server version: {version}" : "Ceangailte. Leagan an fhreastalaí: {version}",
    "Database connection" : "Nasc bunachar sonraí",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "De réir réamhshocraithe, úsáideann na seiceálacha an nasc céanna le Nextcloud. Sonraigh nasc ar leith anseo chun iad a rith mar úsáideoir a bhfuil cearta aige nach dteastaíonn ó Nextcloud — mar shampla, chun cumraíocht iomlán an fhfreastalaí a léamh. Fág an réimse óstach (host) bán chun an nasc réamhshocraithe a úsáid.",
    "Host" : "Óstach",
    "Port" : "Port",
    "User" : "Úsáideoir",
    "Password (stored, leave empty to keep)" : "Focal faire (stóráilte; fág folamh chun é a choinneáil)",
    "Password" : "Pasfhocal",
    ...
    "Save" : "Sábháil",
    "Configuration snippet" : "Mír chumraíochta",
    "Add the following to your {file}, then restart the database." : "Cuir an méid seo a leanas le do {file}, agus ansin athtosaigh an bunachar sonraí.",
    "Copied" : "Cóipeáladh",
    "Copy to clipboard" : "Cóipeáil chuig an ngearrthaisce",
    "Could not copy to clipboard. Select the text above manually instead." : "Níorbh fhéidir cóipeáil chuig an ngearrthaisce. Roghnaigh an téacs thuas de láimh ina ionad sin.",
    "Close" : "Dún",
    ...
    "Resource usage not available" : "Níl úsáid acmhainní ar fáil",
    "Monitoring pages" : "Leathanaigh mhonatóireachta",
    "Shares" : "Scaireanna",
    "Users:" : "Úsáideoirí:",
    "Groups:" : "Grúpaí:",
    "Links:" : "Naisc:",
    ...
    "Temperature" : "Teocht",
    "All" : "Gach",
    "The database checks could not be run." : "Níorbh fhéidir na seiceálacha bunachair sonraí a rith.",
    "Database checks" : "Seiceálacha bunachar sonraí",
    "Database connection settings" : "Socruithe nasc bunachar sonraí",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Ní chlúdaíonn na seiceálacha seo ach MySQL, MariaDB agus PostgreSQL. Baineann an freastalaí seo úsáid as bunachar sonraí difriúil.",
    "Filter checks by status" : "Scag seiceálacha de réir stádais",
    "No checks match this filter." : "Níl aon seiceálacha a oireann don scagaire seo.",
    "_%n failing_::_%n failing_" : ["%n ag teip","%n ag teip","%n ag teip","%n ag teip","%n ag teip"],
    "The server information could not be loaded." : "Níorbh fhéidir faisnéis an fhreastalaí a luchtú.",
    "Try again" : "Déan iarracht arís",
    "These values stopped updating at {time}: the server is not responding." : "Stop na luachanna seo á nuashonrú ag {time}: níl an freastalaí ag freagairt.",
    "The live values could not be loaded: the server is not responding." : "Níorbh fhéidir na luachanna beo a luchtú: níl an freastalaí ag freagairt.",
