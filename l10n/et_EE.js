OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Andmebaasi seadistuste kontrollimine ei õnnestunud.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Järgnevad kontrollid kastavaid nimetatud andmebaase: MySQL, MariaDB ja PostgreSQL.",
    "All database checks pass." : "Kõik andmebaasikontrollid on läbitud.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["%n andmebaasikontroll andis vastuseks vea. {link}","%n andmebaasikontrolli andsid vastuseks vea. {link}"],
    "Show the findings…" : "Näita tulemusi…",
    "Unknown" : "Teadmata",
    ...
    "The slow jobs statistics are not available yet. They are collected by a background job and appear after its next run." : "Aeglaste taustatööde statistika pole veel saadaval. Seda teavet kogub eraldi taustaprotsess ning andmed on nähtavad pärast järgmist käivitust.",
    ...
    "The number of CPU threads is unknown, so the load cannot be shown as a percentage." : "Protsessorilõimede arv pole teada ja seega protsentuaalset koormust ei saa kuvada.",
    "Queries per second" : "Päringuid sekundis",
    "Transactions per second" : "Transaktsioone sekundis",
    "Current connections" : "Praegused ühendused",
    "connections" : "ühendust",
    "Database latency" : "Andmebaasi latentsus",
    "Passing" : "Korras",
    "Skipped" : "Vahelejäetud",
    "Failing" : "Ebaõnnestunud",
    "Alert" : "Hoiatus",
    "Notice" : "Teade",
    "Warning" : "Hoiatus (warning)",
    "Value" : "Väärtus",
    "Setting" : "Seadistus",
    "restart required" : "vajalik on uuesti käivitamine",
    "Note" : "Märge",
    "Show config snippet" : "Näita seadistuste lõigendit",
    "Documentation ↗" : "Dokumentatsioon ↗",
    "Database" : "Andmebaas",
    "Type:" : "Tüüp:",
    "Version:" : "Versioon:",
    "Size:" : "Suurus:",
    "Connected. Server version: {version}" : "Ühendatud. Serveri versioon: {version}",
    "Database connection" : "Andmebaasi ühendus",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "Vaikimisi kasutavad kontrollpäringud sama ühendust, nagu Nextcloudi server. Kui tahad kuvada väärtusi, mida Nextcloud ei vaja ega kasuta, võid määratleda muu kasutaja õigustes toimiva ühenduse - näiteks nii saad kuvada serveri täisseadistust. Vaikimisi ühenduse jaoks jäta väärtus tühjaks.",
    "Host" : "Host",
    "Port" : "Port",
    "User" : "Kasutaja",
    "Password (stored, leave empty to keep)" : "Salasõna (salvestatud, säilitamiseks jäta tühjaks)",
    "Password" : "Salasõna",
    ...
    "Save" : "Salvesta",
    "Configuration snippet" : "Seadistuste lõigend",
    "Add the following to your {file}, then restart the database." : "Lisa järgnev oma „{file}“ faili ja seejärel käivita andmebaas uuesti.",
    "Copied" : "Kopeeritud",
    "Copy to clipboard" : "Kopeeri lõikelauale",
    "Could not copy to clipboard. Select the text above manually instead." : "Lõikelauale kopeerimine ei õnnestunud. Palun kopeeri ülalolev tekst käsitsi.",
    "Close" : "Sulge",
    ...
    "Resource usage not available" : "Ressursikasutus pole saadaval",
    "Monitoring pages" : "Monitooringulehed",
    "Shares" : "Jagamised",
    "Users:" : "Kasutajaid:",
    "Groups:" : "Gruppe:",
    "Links:" : "Linke:",
    ...
    "All" : "Kõik",
    "The database checks could not be run." : "Andmebaasikontrollide käivitamine ei õnnestunud.",
    "Database checks" : "Andmebaasikontrollid",
    "Database connection settings" : "Andmebaasiühenduse seadistused",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Järgnevad kontrollid kastavaid nimetatud andmebaase: MySQL, MariaDB ja PostgreSQL. Sinu serveris on kasutusel muu andmebaasimootor.",
    "Filter checks by status" : "Filtreeri kontrolle oleku järgi",
    "No checks match this filter." : "Sinu filtrile ei vasta ükski kontroll.",
    "_%n failing_::_%n failing_" : ["%n on ebaõnnestunud","%n on ebaõnnestunud"],
    "The server information could not be loaded." : "Serveri teabe laadimine ei õnnestunud",
    "Try again" : "Proovi uuesti",
    "These values stopped updating at {time}: the server is not responding." : "Nende väärtuste uuendamine lõppes {time}: server enam ei vasta päringutele.",
    "The live values could not be loaded: the server is not responding." : "Väärtuste laadimine reaalajas ei õnnestu: server enam ei vasta päringutele.",
