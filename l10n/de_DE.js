OC.L10N.register(
    ...
    "Skip app updates (including app updates will send an external request to the app store)" : "App-Updates überspringen (einschließlich App-Updates sendet eine externe Anfrage an den App Store)",
