OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Veritabanı yapılandırması denetlenemedi.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Bu denetimler yalnızca MySQL, MariaDB ve PostgreSQL veri tabanlarını kapsar.",
    "All database checks pass." : "Tüm veri tabanı denetimleri sorunsuz tamamlandı.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["%n veri tabanı denetiminde sorun bulundu. {link}","%n veri tabanı denetiminde sorun bulundu. {link}"],
    "Show the findings…" : "Bulguları görüntüle…",
    "Unknown" : "Bilinmiyor",
    ...
    "The number of CPU threads is unknown, so the load cannot be shown as a percentage." : "İşlemci işlemleri sayısı bilinmiyor. Bu nedenle yük yüzde olarak gösterilemiyor.",
    "Queries per second" : "Bir saniyedeki sorgu sayısı",
    "Transactions per second" : "Bir saniyedeki işlem sayısı",
    ...
    "Note" : "Not",
    "Show config snippet" : "Yapılandırma kod parçasını görüntüle",
    "Documentation ↗" : "Belgeler ↗",
    "Database" : "Veri tabanı",
    "Type:" : "Tür:",
    "Version:" : "Sürüm:",
    "Size:" : "Boyut:",
    "Connected. Server version: {version}" : "Bağlandı. Sunucu sürümü: {version}",
    "Database connection" : "Veri tabanı bağlantısı",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "Varsayılan olarak denetimler Nextcloud ile aynı bağlantıyı kullanır. Nextcloud tarafından gerek duyulmayan izinlere sahip bir kullanıcı olarak çalıştırmak için burada ayrı bir bağlantı verin. Örneğin tam sunucu yapılandırmasını okumak için. Varsayılan bağlantının kullanılması için sunucuyu boş bırakın.",
    "Host" : "Sunucu",
    "Port" : "Bağlantı noktası",
    "User" : "Kullanıcı",
    "Password (stored, leave empty to keep)" : "Parola (kaydedilmiş, değiştirilmemesi için boş bırakın)",
    "Password" : "Parola",
    ...
    "Save" : "Kaydet",
    "Configuration snippet" : "Yapılandırma kod parçası",
    "Add the following to your {file}, then restart the database." : "{file} dosyanıza ekledikten sonra veri tabanını yeniden başlatın.",
    "Copied" : "Kopyalandı",
    "Copy to clipboard" : "Panoya kopyala",
    "Could not copy to clipboard. Select the text above manually instead." : "Panoya kopyalanamadı. Bunun yerine yukarıdaki yazıyı el ile seçin.",
    "Close" : "Kapat",
    ...
    "Resource usage not available" : "Kaynak kullanımı görüntülenemiyor",
    "Monitoring pages" : "Sayfalar izleniyor",
    "Shares" : "Paylaşımlar",
    "Users:" : "Kullanıcılar:",
    "Groups:" : "Gruplar:",
    "Links:" : "Bağlantılar:",
    ...
    "All" : "Tümü",
    "The database checks could not be run." : "Veri tabanı denetimleri yapılamadı.",
    "Database checks" : "Veri tabanı denetimleri",
    "Database connection settings" : "Veri tabanı bağlantı ayarları",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Bu denetimler yalnızca MySQL, MariaDB ve PostgreSQL veri tabanlarını kapsar. Bu sunucu farklı bir veri tabanı kullanıyor.",
    "Filter checks by status" : "Denetimleri duruma göre süz",
    "No checks match this filter." : "Bu süzgece uyan bir denetim yok.",
    "_%n failing_::_%n failing_" : ["%n sorunlu","%n sorunlu"],
    "The server information could not be loaded." : "Sunucu bilgileri yüklenemedi.",
    "Try again" : "Yeniden dene",
    "These values stopped updating at {time}: the server is not responding." : "Bu değerlerin güncellenmesi {time} zamanında durmuş: Sunucu yanıt vermiyor.",
    "The live values could not be loaded: the server is not responding." : "Canlı değerler yüklenemedi: Sunucu yanıt vermiyor.",
