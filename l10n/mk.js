OC.L10N.register(
    ...
    {
    "System" : "Систем",
    "Database configuration" : "Конфигурација за база на податоци",
    "Unknown" : "Непознат",
    "%1$d days, %2$d hours, %3$d minutes, %4$d seconds" : "%1$d дена, %2$d часа, %3$d минути, %4$d секунди",
    "%1$d hours, %2$d minutes, %3$d seconds" : "%1$d часа, %2$d минути, %3$d секунди",
    "Monitoring" : "Следење",
    ...
    "{0}% of all users" : "{0}% од сите корисници",
    "Active users" : "Активни корисници",
    "Last hour" : "Предходен час",
    "Last 24 Hours" : "Предходни 24 часа",
    "Last 7 Days" : "Предходни 7 дена",
    "Last 30 Days" : "Предходни 30 дена",
    "Webcron" : "Webcron",
    "AJAX (not recommended)" : "AJAX (не се препорачува)",
    "Background jobs" : "Задачи кој се извршуваат во позадина",
    "Mode" : "Мод",
    "Last run" : "Последно извршување",
    "Never" : "Никогаш",
    "Latest runs" : "Последни извршувања",
    "No background job has run yet." : "Сеуште нема извршено ниедна позадинска задача.",
    "Slowest jobs" : "Најбавни задачи",
    "Load" : "Искористеност",
    ...
    "Version:" : "Верзија:",
    "Size:" : "Големина:",
    "Database connection" : "Врска на база на податоци",
    "Host" : "Домаќин",
    "Port" : "Порта",
    "User" : "Корисник",
    "Password" : "Лозинка",
    ...
    "Close" : "Затвори",
    "{used} of {total} used" : "Искористено {used} од {total}",
    "Used" : "Искористено",
    "Available" : "Достапно",
    "Disk" : "Диск",
    "Files" : "Датотеки",
    ...
    "Failed" : "Неуспешно",
    "Running" : "Трчање",
    "RAM usage" : "Искористување на RAM",
    "Swap usage" : "Искористување на SWAP",
    "Memory" : "Меморија",
    "RAM info not available" : "Информации за RAM меморијата не се достапни",
    "Total" : "Вкупно",
    "Swap used" : "Искористен SWAP",
    "External monitoring API" : "Надворешен уред за следење",
    "Configuration" : "Конфигурација",
    "Output in JSON" : "Излез во JSON",
    ...
    "IPv4:" : "IPv4:",
    "IPv6:" : "IPv6:",
    "OPcache is not loaded." : "OPcache не е вчитан.",
    "OPcache is disabled." : "OPcache е оневозможен.",
    "{used} of {total}" : "{used} од {total}",
    "{used} of {max}" : "{used} од {max}",
