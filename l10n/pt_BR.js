OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Não foi possível verificar a configuração do banco de dados.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Essas verificações abrangem apenas o MySQL, o MariaDB e o PostgreSQL.",
    "All database checks pass." : "Todas as verificações do banco de dados foram concluídas com êxito.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["%n verificação do banco de dados está falhando. {link}","%n de verificações do banco de dados estão falhando. {link}","%n verificações do banco de dados estão falhando. {link}"],
    "Show the findings…" : "Apresentar os resultados…",
    ...
    "The number of CPU threads is unknown, so the load cannot be shown as a percentage." : "O número de threads da CPU é desconhecido; portanto, a carga não pode ser exibida em porcentagem.",
    "Queries per second" : "Solicitações por segundo",
    "Transactions per second" : "Transações por segundo",
    "Current connections" : "Conexões atuais",
    "connections" : "conexões",
    "Database latency" : "Latência do banco de dados",
    "Passing" : "Êxito",
    "Skipped" : "Ignorado",
    "Failing" : "Falha",
    "Alert" : "Alerta",
    ...
    "Version:" : "Versão:",
    "Size:" : "Tamanho:",
    "Connected. Server version: {version}" : "Conectado. Versão do servidor: {version}",
    "Database connection" : "Conexão com o banco de dados",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "Por padrão, as verificações utilizam a mesma conexão do Nextcloud. Insira aqui uma conexão separada para executá-las como um usuário com permissões que o Nextcloud não necessita, por exemplo, para ler a configuração completa do servidor. Deixe o campo hospedeiro em branco para usar a conexão padrão.",
    "Host" : "Hospedeiro",
    "Port" : "Porta",
    "User" : "Usuário",
    "Password (stored, leave empty to keep)" : "Senha (armazenada, deixe em branco para mantê-la)",
    "Password" : "Senha",
    "Database name" : "Nome do banco de dados",
    "Driver" : "Driver",
    "Cancel" : "Cancelar",
    "Test connection" : "Verificar conexão",
    "Save" : "Salvar",
    "Configuration snippet" : "Trecho de configuração",
    "Add the following to your {file}, then restart the database." : "Adicione o seguinte ao seu {file} e, em seguida, reinicie o banco de dados.",
    "Copied" : "Copiado",
    "Copy to clipboard" : "Copiar para área de transferência",
    "Could not copy to clipboard. Select the text above manually instead." : "Não foi possível copiar para a área de transferência. Selecione o texto acima manualmente.",
    "Close" : "Fechar",
    ...
    "Resource usage not available" : "Informações sobre o uso de recursos não estão disponíveis",
    "Monitoring pages" : "Páginas de monitoramento",
    ...
    "All" : "Tudo",
    "The database checks could not be run." : "Não foi possível executar as verificações do banco de dados.",
    "Database checks" : "Verificações do banco de dados",
    "Database connection settings" : "Configurações de conexão com o banco de dados",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Essas verificações abrangem apenas o MySQL, o MariaDB e o PostgreSQL. Este servidor utiliza um banco de dados diferente.",
    "Filter checks by status" : "Filtrar verificações por status",
    "No checks match this filter." : "Nenhuma verificação corresponde a este filtro.",
    "_%n failing_::_%n failing_" : ["%n falha","%n de falhas","%n falhas"],
    "The server information could not be loaded." : "Não foi possível carregar as informações do servidor.",
    "Try again" : "Tentar novamente",
    "These values stopped updating at {time}: the server is not responding." : "Esses valores pararam de ser atualizados às {time}: o servidor não está respondendo.",
    "The live values could not be loaded: the server is not responding." : "Não foi possível carregar os valores em tempo real: o servidor não está respondendo.",
