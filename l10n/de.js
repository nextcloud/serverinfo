OC.L10N.register(
    ...
    "The database configuration could not be checked." : "Die Datenbankkonfiguration konnte nicht geprüft werden.",
    "These checks only cover MySQL, MariaDB and PostgreSQL." : "Diese Überprüfungen decken nur MySQL, MariaDB und PostgreSQL ab.",
    "All database checks pass." : "Alle Datenbanküberprüfungen bestanden.",
    "_%n database check is failing. {link}_::_%n database checks are failing. {link}_" : ["%n Datenbanküberprüfung ist fehlgeschlagen. {link}","%n Datenbanküberprüfungen sind fehlgeschlagen. {link}"],
    "Show the findings…" : "Zeige Ergebnisse an …",
    "Unknown" : "Unbekannt",
    ...
    "Note" : "Notiz",
    "Show config snippet" : "Konfigurations-Snippet anzeigen",
    "Documentation ↗" : "Dokumentation ↗",
    "Database" : "Datenbank",
    "Type:" : "Art:",
    "Version:" : "Version:",
    "Size:" : "Größe:",
    "Connected. Server version: {version}" : "Verbunden. Serverversion: {version}",
    "Database connection" : "Datenbankverbindung",
    "By default the checks use the same connection as Nextcloud. Give a separate connection here to run them as a user with the rights Nextcloud does not need, for example to read the full server configuration. Leave the host empty to use the default connection." : "Standardmäßig verwenden die Prüfungen dieselbe Verbindung wie Nextcloud. Hier kann eine separate Verbindung angegeben werden, um die Prüfungen als Benutzer mit Rechten auszuführen, die Nextcloud nicht benötigt, beispielsweise um die vollständige Serverkonfiguration auszulesen. Das Feld \"Host\" leer lassen, um die Standardverbindung zu verwenden.",
    "Host" : "Host",
    "Port" : "Port",
    "User" : "Benutzer",
    "Password (stored, leave empty to keep)" : "Passwort (gespeichert, leer lassen um es zu behalten)",
    "Password" : "Passwort",
    ...
    "Save" : "Speichern",
    "Configuration snippet" : "Konfigurations-Snippet",
    "Add the following to your {file}, then restart the database." : "Folgendes zu deiner {file}-Datei hinzufügen, danach muss die Datenbank neugestartet werden.",
    "Copied" : "Kopiert",
    "Copy to clipboard" : "In die Zwischenablage kopieren",
    "Could not copy to clipboard. Select the text above manually instead." : "Konnte nicht in die Zwischenablage kopieren. Den obigen Text bitte manuell kopieren.",
    "Close" : "Schließen",
    ...
    "Resource usage not available" : "Ressourcenverbrauch nicht verfügbar",
    "Monitoring pages" : "Überwachungsseiten",
    "Shares" : "Freigaben",
    "Users:" : "Benutzer:",
    "Groups:" : "Gruppen:",
    "Links:" : "Links:",
    ...
    "All" : "Alle",
    "The database checks could not be run." : "Die Datenbankprüfungen konnten nicht durchgeführt werden.",
    "Database checks" : "Datenbanküberprüfungen",
    "Database connection settings" : "Einstellungen für die Datenbankverbindung",
    "These checks only cover MySQL, MariaDB and PostgreSQL. This server uses a different database." : "Diese Überprüfungen decken nur MySQL, MariaDB und PostgreSQL ab. Dieser Server nutzt eine andere Datenbank.",
    "Filter checks by status" : "Überprüfungen nach Status filtern",
    "No checks match this filter." : "Keine Überprüfungen entsprechen dem Filter.",
    "_%n failing_::_%n failing_" : ["%n fehlgeschlagen","%n fehlgeschlagen"],
    "The server information could not be loaded." : "Die Serverinformationen konnten nicht geladen werden.",
    "Try again" : "Erneut versuchen",
    "These values stopped updating at {time}: the server is not responding." : "Die Aktualisierung dieser Werte wurde um {time} unterbrochen: Der Server reagiert nicht.",
    "The live values could not be loaded: the server is not responding." : "Die Live-Werte konnten nicht geladen werden: Der Server reagiert nicht.",
